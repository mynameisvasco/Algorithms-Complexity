...
{
  if (DateTimeCompare(ti1->end, ti2->end) > -1)
  {
    return -1;
  }
...
{
  return (DateTimeCompare(ti1->start, ti2->start) == -1 ||
          DateTimeCompare(ti1->start, ti2->start) == 0) &&
         (DateTimeCompare(ti1->end, ti2->end) == 0 ||
          DateTimeCompare(ti1->end, ti2->end) == 1);
}
